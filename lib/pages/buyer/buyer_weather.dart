      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            ...
            const Color(0xFF1B5E20).withOpacity(0.70),
            const Color(0xFF0F766E).withOpacity(0.62),
            const Color(0xFF1E40AF).withOpacity(0.38),
          ],
        ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            const Color(0xFF0B3D1B).withOpacity(0.78),
            const Color(0xFF1B5E20).withOpacity(0.70),
